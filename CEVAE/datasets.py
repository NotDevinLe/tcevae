...
class IHDP(object):
    def __init__(self, path_data=None, replications=10):
        self.path_data = path_data or os.path.join(_DIR, "datasets", "IHDP", "csv")
    ...
    def __iter__(self):
        for i in range(self.replications):
            data = np.loadtxt(os.path.join(self.path_data, f'ihdp_npci_{i + 1}.csv'), delimiter=',')
